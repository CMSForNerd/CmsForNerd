...
/**
 * CmsForNerd v4.3.0 - Page Controller (welcome-kit.php)
 ...
 */
$content = [
    'title'       => "Student Welcome Kit: Essential Cheat Sheet - CMSForNerd v4.3.0",
    'author'      => "CMSForNerd Team & Google Gemini",
    'description' => "The one-stop reference guide for every student entering the CmsForNerd v4.3.0 Laboratory.",
