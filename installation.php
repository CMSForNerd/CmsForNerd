...
/**
 * CmsForNerd v4.0.0-alpha - Page Controller (installation.php)
 ...
 */
$content = [
    'title'       => "Installation Guide | CMSForNerd v4.0.0-alpha Laboratory",
    'author'      => "CMSForNerd Team & Gemini AI",
    'description' => "Official deployment steps for CMSForNerd v4.0.0-alpha. Learn how to install the flat-file core on modern PHP 8.4 environments.",
