...
/**
 * CmsForNerd v4.0.0-alpha - Page Controller (exam-answers.php)
 ...
 */
$content = [
    'title'          => "Official Answer Key: Final Exam | CMSForNerd v4.0.0-alpha",
    'author'         => "CMSForNerd Team & Google Gemini",
    'description'    => "Instructor grading rubric and official logic solutions for the CMSForNerd v4.0.0-alpha Final Exam.",
