...
/**
 * CMSForNerd v4.3.0 - Web Environment Sanity Check (Secure Version)
...
$isCli = PHP_SAPI === 'cli';
$title = "🧪 CMSForNerd v4.3.0 Sanity Check";
    ...
    <div class="card">
        ...
        <?php if (!in_array(false, $requirements, true)) : ?>
            <div class="verdict verdict-pass">
                ✅ Your Web Server is fully optimized for the v4.3.0 Laboratory!
            </div>
        <?php else : ?>
