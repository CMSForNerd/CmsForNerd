...
/**
 * CmsForNerd v4.0.0-alpha - Page Controller (history.php)
 * * ROLE: Chronological log of the CMSForNerd v3.1 - v4.0.0-alpha evolution.
 ...
 */
$content = [
    'title'       => "Modernization History | CMSForNerd v4.0.0-alpha Evolution",
